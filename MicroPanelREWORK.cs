...
{
    [Info("MicroPanel", "0killrest", "2.0.9d")]
    public class MicroPanel : RustPlugin
    {
        ...
        {
            [JsonProperty("Лейбел")] public string ServerName = "<b><color=#ff8200>Название</color></b>"; //название которое будет отображаться на панели
            [JsonProperty("Иконка")] public string icon = ""; // Логотип
            ...
            public static ConfigData GetNewConf()
            {
                ...
                newConfig.buttonList = new List<Buttons>()
                {
                    ...
                    new Buttons()
                    {
                        Commnad = "chat.say /kit",
                        Name = "[- Киты -]",
                    },
                    new Buttons()
                    {
                        Commnad = "chat.say /home",
                        Name = "[- ТП Домой -]",
                    },
                };
                newConfig.newsList = new List<string>()
                {
                    "ссылка, //Будет на панели 
                    "ссылка" //Будет на панели 
                };
                return newConfig;
            }
        ...
        #endregion
        private string Layer = "MicroPanelBy0killrest";
